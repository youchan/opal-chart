...
/* Generated by Opal 0.11.4 */
(function(Opal) {
  var TMP_1, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $send = Opal.send, $range = Opal.range, $hash2 = Opal.hash2, random = nil, data = nil, params = nil, chart = nil;

  Opal.add_stubs(['$require', '$==', '$new', '$rand', '$create']);
  ...
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
    ...
    data = $send(Opal.const_get_relative($nesting, 'Array'), 'new', [6], (TMP_1 = function(){var self = TMP_1.$$s || this;

    return random.$rand($range(1, 20, false))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
    params = $hash2(["type", "data", "options"], {"type": "bar", "data": $hash2(["labels", "datasets"], {"labels": ["Red", "Blue", "Yellow", "Green", "Purple", "Orange"], "datasets": [$hash2(["label", "data", "backgroundColor", "borderColor", "borderWidth"], {"label": "# of Votes", "data": data, "backgroundColor": ["rgba(255, 99, 132, 0.2)", "rgba(54, 162, 235, 0.2)", "rgba(255, 206, 86, 0.2)", "rgba(75, 192, 192, 0.2)", "rgba(153, 102, 255, 0.2)", "rgba(255, 159, 64, 0.2)"], "borderColor": ["rgba(255, 99, 132, 1)", "rgba(54, 162, 235, 1)", "rgba(255, 206, 86, 1)", "rgba(75, 192, 192, 1)", "rgba(153, 102, 255, 1)", "rgba(255, 159, 64, 1)"], "borderWidth": 1})]}), "options": $hash2(["scales"], {"scales": $hash2(["yAxes"], {"yAxes": [$hash2(["ticks"], {"ticks": $hash2(["beginAtZero"], {"beginAtZero": true})})]})})});
    chart = Opal.const_get_qualified(Opal.const_get_relative($nesting, 'OpalChart'), 'NativeChart').$new();
    return chart.$create("ctx", params);
    } else {
    return nil
  };
})(Opal);
