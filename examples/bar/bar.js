...
/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart/camelize"] = function(Opal) {
  ...
  Opal.add_stubs(['$include?', '$join', '$with_index', '$map', '$split', '$==', '$capitalize', '$include']);
  
  (function($base, $parent_nesting) {
    var $Camelize, self = $Camelize = $module($base, 'Camelize');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Camelize_to_js_camel_2;

    
    Opal.defn(self, '$to_js_camel', TMP_Camelize_to_js_camel_2 = function $$to_js_camel() {
      var TMP_1, self = this;

      if ($truthy(self['$include?']("_"))) {
        return $send(self.$split("_").$map(), 'with_index', [], (TMP_1 = function(w, i){var self = TMP_1.$$s || this;
if (w == null) w = nil;if (i == null) i = nil;
        if (i['$=='](0)) {
            return w
            } else {
            return w.$capitalize()
    ...
    }, TMP_Camelize_to_js_camel_2.$$arity = 0)
  })($nesting[0], $nesting);
  return Opal.const_get_relative($nesting, 'String').$include(Opal.const_get_relative($nesting, 'Camelize'));
};

/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart/version"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  return (function($base, $parent_nesting) {
    var $OpalChart, self = $OpalChart = $module($base, 'OpalChart');
...
/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart/native_chart"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var self = $NativeChart = $klass($base, $super, 'NativeChart', $NativeChart);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_NativeChart_create_1;

      return (Opal.defn(self, '$create', TMP_NativeChart_create_1 = function $$create(canvas, params) {
        var self = this;
      ...
      ;
      }, TMP_NativeChart_create_1.$$arity = 2), nil) && 'create'
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart/plot/configulator"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$class', '$dataset_properties', '$each', '$define_singleton_method', '$instance_variable_get', '$configulator', '$send']);
  return (function($base, $parent_nesting) {
    var $OpalChart, self = $OpalChart = $module($base, 'OpalChart');
    ...
    (function($base, $parent_nesting) {
      var $Plot, self = $Plot = $module($base, 'Plot');

      var def = self.$$proto, $nesting = [self].concat($parent_nesting);

      (function($base, $super, $parent_nesting) {
        function $Configulator(){};
        var self = $Configulator = $klass($base, $super, 'Configulator', $Configulator);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Configulator_initialize_4;

        return (Opal.defn(self, '$initialize', TMP_Configulator_initialize_4 = function $$initialize(plot) {
          var TMP_1, self = this;

          
          $send(self.$class(), 'attr_accessor', Opal.to_a(plot.$dataset_properties()));
          return $send(plot.$dataset_properties(), 'each', [], (TMP_1 = function(property){var self = TMP_1.$$s || this, TMP_2, TMP_3;
if (property == null) property = nil;
          
            $send(plot, 'define_singleton_method', [property], (TMP_2 = function(){var self = TMP_2.$$s || this;

            return self.$configulator().$instance_variable_get("" + "@" + (property))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
            return $send(self, 'define_singleton_method', [property], (TMP_3 = function(val){var self = TMP_3.$$s || this;
if (val == null) val = nil;
            return self.$send("" + (property) + "=", val)}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1));
        }, TMP_Configulator_initialize_4.$$arity = 1), nil) && 'initialize'
      })($nesting[0], null, $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
...
/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart/plot/bar"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $send = Opal.send;

  Opal.add_stubs(['$require', '$attr_reader', '$new', '$instance_eval', '$to_proc']);
  
  self.$require("opal_chart/plot/configulator");
  return (function($base, $parent_nesting) {
    var $OpalChart, self = $OpalChart = $module($base, 'OpalChart');
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Bar_initialize_1, TMP_Bar_config_2;

        def.configulator = nil;
        
        self.$attr_reader("type", "dataset_properties", "configulator");
        
        Opal.defn(self, '$initialize', TMP_Bar_initialize_1 = function $$initialize() {
          var self = this;

          
          self.type = "bar";
          self.dataset_properties = ["data", "label", "background_color", "border_color"];
          return (self.configulator = Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'OpalChart'), 'Plot'), 'Configulator').$new(self));
        }, TMP_Bar_initialize_1.$$arity = 0);
        return (Opal.defn(self, '$config', TMP_Bar_config_2 = function $$config() {
          var self = this, $iter = TMP_Bar_config_2.$$p, block = $iter || nil;

          if ($iter) TMP_Bar_config_2.$$p = null;
          return $send(self.configulator, 'instance_eval', [], block.$to_proc())
        }, TMP_Bar_config_2.$$arity = 0), nil) && 'config';
      })($nesting[0], null, $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting);
};
...
/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart/figure"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$new', '$config', '$to_proc', '$<<', '$map', '$to_h', '$dataset_properties', '$to_js_camel', '$to_s', '$send', '$create', '$params']);
  
  self.$require("opal_chart/plot/bar");
  return (function($base, $parent_nesting) {
    var $OpalChart, self = $OpalChart = $module($base, 'OpalChart');
    ...
    (function($base, $super, $parent_nesting) {
      function $Figure(){};
      var self = $Figure = $klass($base, $super, 'Figure', $Figure);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Figure_initialize_1, TMP_Figure_add_bar_2, TMP_Figure_params_5, TMP_Figure_render_6;

      def.plots = def.labels = nil;
      
      self.$attr_accessor("plots", "option", "labels");
      
      Opal.defn(self, '$initialize', TMP_Figure_initialize_1 = function $$initialize(labels) {
        var self = this;
        ...
        self.labels = labels;
        self.plots = [];
        return (self.option = $hash2([], {}));
      }, TMP_Figure_initialize_1.$$arity = -1);
      
      Opal.defn(self, '$add_bar', TMP_Figure_add_bar_2 = function $$add_bar() {
        var self = this, $iter = TMP_Figure_add_bar_2.$$p, block = $iter || nil, bar = nil;

        if ($iter) TMP_Figure_add_bar_2.$$p = null;
        
        bar = Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'OpalChart'), 'Plot'), 'Bar').$new();
        $send(bar, 'config', [], block.$to_proc());
        return self.plots['$<<'](bar);
      }, TMP_Figure_add_bar_2.$$arity = 0);
      
      Opal.defn(self, '$params', TMP_Figure_params_5 = function $$params() {
        var TMP_3, self = this;

        return $hash2(["type", "data"], {"type": "bar", "data": $hash2(["labels", "datasets"], {"labels": self.labels, "datasets": $send(self.plots, 'map', [], (TMP_3 = function(plot){var self = TMP_3.$$s || this, TMP_4;
if (plot == null) plot = nil;
        return $send(plot.$dataset_properties(), 'map', [], (TMP_4 = function(property){var self = TMP_4.$$s || this;
if (property == null) property = nil;
          return [property.$to_s().$to_js_camel(), plot.$send("" + (property))]}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4)).$to_h()}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3))})})
      }, TMP_Figure_params_5.$$arity = 0);
      return (Opal.defn(self, '$render', TMP_Figure_render_6 = function $$render() {
        var self = this, native$ = nil;

        
        native$ = Opal.const_get_relative($nesting, 'NativeChart').$new();
        return native$.$create("ctx", self.$params());
      }, TMP_Figure_render_6.$$arity = 0), nil) && 'render';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["opal_chart"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require']);
  
  self.$require("opal_chart/camelize");
  self.$require("opal_chart/version");
  self.$require("opal_chart/native_chart");
  self.$require("opal_chart/figure");
  return (function($base, $parent_nesting) {
    var $OpalChart, self = $OpalChart = $module($base, 'OpalChart');
...
(function(Opal) {
  ...
  var TMP_1, TMP_2, TMP_4, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $send = Opal.send, $range = Opal.range, random = nil, result = nil, sum = nil, figure = nil;

  Opal.add_stubs(['$require', '$==', '$new', '$times', '$+', '$rand', '$-', '$to_i', '$[]', '$[]=', '$to_a', '$add_bar', '$data', '$label', '$background_color', '$border_color', '$render']);
  
  self.$require("opal");
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
    
    self.$require("opal-jquery");
    self.$require("opal_chart");
    self.$require("native");
    self.$require("js");
    random = Opal.const_get_relative($nesting, 'Random').$new();
    result = $send(Opal.const_get_relative($nesting, 'Array'), 'new', [10], (TMP_1 = function(){var self = TMP_1.$$s || this;

    return 0}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
    sum = 0;
    $send((100), 'times', [], (TMP_2 = function(){var self = TMP_2.$$s || this, TMP_3, $writer = nil;

    
      $send((10), 'times', [], (TMP_3 = function(){var self = TMP_3.$$s || this;

      return (sum = $rb_plus(sum, random.$rand(2)))}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3));
      
      $writer = [$rb_minus(sum.$to_i(), 1), $rb_plus(result['$[]']($rb_minus(sum.$to_i(), 1)), 1)];
      $send(result, '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return (sum = 0);}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
    figure = Opal.const_get_qualified(Opal.const_get_relative($nesting, 'OpalChart'), 'Figure').$new($range(1, 10, false).$to_a());
    $send(figure, 'add_bar', [], (TMP_4 = function(){var self = TMP_4.$$s || this, TMP_5, TMP_6;

    
      self.$data(result);
      self.$label("binomial distribution");
      self.$background_color($send(Opal.const_get_relative($nesting, 'Array'), 'new', [10], (TMP_5 = function(){var self = TMP_5.$$s || this;

      return "rgba(54, 162, 235, 0.2)"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5)));
      return self.$border_color($send(Opal.const_get_relative($nesting, 'Array'), 'new', [10], (TMP_6 = function(){var self = TMP_6.$$s || this;

      return "rgba(255, 99, 132, 0.2)"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6)));}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4));
